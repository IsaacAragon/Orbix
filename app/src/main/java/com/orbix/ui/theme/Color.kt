...
val LightSurfaceVariant = Color(0xFFEAE3DD)
val LightOnSurfaceVariant = Color(0xFF4C4639)
val LightSurfaceContainerHigh = Color(0xFFF0EDEA)
...
val DarkSurfaceVariant = Color(0xFF4C4639)
val DarkOnSurfaceVariant = Color(0xFFCDC4B8)
val DarkSurfaceContainerHigh = Color(0xFF2B2826)
